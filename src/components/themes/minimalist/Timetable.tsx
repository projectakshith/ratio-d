  ...
  return (
    <>
      ...
      <div className="absolute inset-0 bg-[#F7F7F7]">
        <div className="h-full w-full overflow-y-auto no-scrollbar px-6 pt-10 pb-[240px] flex flex-col relative">
          <motion.div
            initial={{ opacity: 0, y: 10 }}
            animate={{ opacity: 1, y: 0 }}
            transition={{ duration: 0.4 }}
            className="w-full flex flex-col items-center mt-2 mb-10 shrink-0"
          >
            <span
                  ...
                  return (
                    ...
                    >
                      <div className="w-12 flex justify-center pt-6 shrink-0 relative">
                        <div
                          className={`w-3.5 h-3.5 rounded-full ring-4 ring-[#F7F7F7] z-10 ${item.isCurrent ? "bg-[#ceff1c] animate-pulse shadow-[0_0_12px_rgba(206,255,28,0.8)]" : "bg-[#111111]"}`}
                        />
                        {item.isCurrent && (
                      ...
                      <div
                        className={`flex-1 border-[1.5px] rounded-[24px] p-5 flex flex-col transition-all ${
                          item.isCurrent
                            ? "bg-[#111111] border-transparent shadow-lg scale-[1.02] transform-gpu"
                            : "bg-white border-[#111111]/10 shadow-sm"
                        }`}
                      >
                        <div className="flex justify-between items-start mb-4">
                          <div
                            className={`flex items-center gap-1.5 px-2.5 py-1.5 rounded-[10px] ${item.isCurrent ? "bg-white/10" : "bg-[#F7F7F7]"}`}
                          >
                            <Clock
                              size={12}
                              className={
                            ...
                            />
                            <span
                              className={`text-[12px] font-bold tracking-widest ${item.isCurrent ? "text-white" : "text-[#111111]"}`}
                              style={{ fontFamily: "'Montserrat', sans-serif" }}
                            >
                              {item.time}
                            </span>
                        ...
                        <span
                          className={`text-[24px] font-black uppercase tracking-widest leading-none mb-1 ${item.isCurrent ? "text-white" : "text-[#111111]"}`}
                          style={{ fontFamily: "'Montserrat', sans-serif" }}
                        >
                          {item.code}
                        </span>
                        <span
                          className={`text-[14px] font-medium lowercase tracking-wide mb-5 ${item.isCurrent ? "text-white/60" : "text-[#111111]/50"}`}
                          style={{ fontFamily: "'Afacad', sans-serif" }}
                        >
                          {item.name}
                        </span>
                        ...
                        <div
                          className={`flex items-center justify-between pt-4 mt-auto border-t ${item.isCurrent ? "border-white/10" : "border-[#111111]/5"}`}
                        >
                          <div className="flex items-center gap-3 flex-wrap">
                            <div className="flex items-center gap-1.5">
                              ...
                              />
                              <span
                                className={`text-[11px] font-bold uppercase tracking-wider ${item.isCurrent ? "text-white" : "text-[#111111]"}`}
                                style={{
                            ...
                            <div
                              className={`w-1 h-1 rounded-full ${item.isCurrent ? "bg-white/20" : "bg-[#111111]/20"}`}
                            />
                            <div className="flex items-center gap-1.5">
                              <User
                                size={12}
                              ...
                              />
                              <span
                                className={`text-[11px] font-bold lowercase tracking-wider ${item.isCurrent ? "text-white/80" : "text-[#111111]/70"}`}
                                style={{ fontFamily: "'Afacad', sans-serif" }}
                              >
                                {item.faculty}
                              </span>
        ...
        <div className="fixed bottom-[110px] left-1/2 -translate-x-1/2 bg-[#111111]/95 backdrop-blur-md p-1.5 pr-2 rounded-full flex items-center gap-1 z-40 shadow-[0_8px_32px_rgba(17,17,17,0.3)] border border-white/10">
          <span
